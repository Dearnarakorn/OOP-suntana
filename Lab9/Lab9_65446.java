...
public class Lab9_65446 {
    ...
    private static List<Employee> q7_1(List<Employee> list){
        List<Employee> l =  Arrays.asList(list.get(0));
        // while(list.size()>1){
    ...
    static void q8() {
        Employee pram = new Employee("pramote");
        List<Employee> list1 = Arrays.asList(new Employee("yindee"), pram); 
        List<Employee> list2 = Arrays.asList(pram, new Employee("preeda"));
        Set<Employee> empSet = new HashSet<>();
        empSet.addAll(list1);
        empSet.addAll(list2);
         /* your task */ List<Employee> q8_ans = new ArrayList<>(empSet);
        System.out.println(q8_ans);
    }

        static void q9() {
            Employee pram = new Employee("pramote");
            Employee yin = new Employee("yindee");
         ...
         /* your task */ empSet1.retainAll(empSet2);
    ...
    static void q10() {
        ...
        list2.add(pram);
        Set<Employee> empSet2 = new HashSet<>(list2);
         /* your task */ empSet1.removeAll(empSet2);
        System.out.println(empSet1);
        }
    ...
    static void q11() {
            ...
            /* your task */ empSet.toArray(q11_ans);
    ...
    static void q12() {
        ...
        for (int i = 0; i < n; i++) {
            /* your task */ map.put(empList.get(i).getName(),empList.get(i));
        }
    ...
    static void q13() {
        ...
        /* your task */ Set<String> keySet = new HashSet<>(map.keySet());
    ...
    // PQ (60072) takes 931,500
    // ArrayList (60072) takes 857,600
